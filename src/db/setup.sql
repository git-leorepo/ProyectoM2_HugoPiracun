...
INSERT INTO authors (name, email, bio) VALUES
  ...
  ('Carolina Contreras', 'caro.contreras@qvision.com', 'Tester QA'),
  ('Hugo Piracun', 'hugo.pracun@globant.com', 'Tester QA');
...
INSERT INTO posts (title, content, author_id, published) VALUES
  ...
  ('Automatizacion con Selenium', 'Automatizacion con POM para webs de streaming...', 4, true),
  ('bootcamp full stack', 'frontend y backend con html, css y js', 5, true);
